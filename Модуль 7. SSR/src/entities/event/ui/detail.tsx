...
type EventActionProps = { action?: ReactNode }
type EventProps = EventDetailProps & EventActionProps
export const EventDetail = ({ title, description, date, participations, action }: EventProps) => {
  return (
    <div>
      <div className="px-4 sm:px-0">
        <h3 className="text-base font-semibold leading-7 text-gray-900">Информация о событии</h3>
      </div>
