...
export const Navbar = () => {
  ...
  return (
    <header className="flex flex-wrap mb-6 rounded-md sm:justify-start sm:flex-nowrap w-full bg-gray-800 text-sm py-4 dark:bg-white">
      <nav
        className="max-w-[85rem] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between"
        aria-label="Global">
        <div className="flex items-center justify-between">
          <Link className="flex-none text-xl font-semibold text-white dark:text-gray-800" href="/">
            События
          </Link>
        ...
        <div
          ...
          <div className="flex flex-col gap-5 mt-5 sm:flex-row sm:items-center sm:justify-end sm:mt-0 sm:pl-5">
            <Links isAuth={isAuthenticated} />
            <AuthAction isAuth={isAuthenticated} />
          </div>
        </div>
      </nav>
    </header>
